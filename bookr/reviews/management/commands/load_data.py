...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        models = dict()
        try:
            with open('C:/Users/josep/Django/bookr_week13_final/bookr/reviews/management/commands/WebDevWithDjangoData.csv') as csvfile:
            ...
            raise CommandError('File "{}" does not exist'.format('WebDevWithDjangoData.csv'))
